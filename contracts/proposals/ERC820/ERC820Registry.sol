...
interface ERC820ImplementerInterface {
    /// @dev Contracts that implement an interferce in behalf of another contract must return true
...
contract ERC820Registry {
    bytes4 public constant InvalidID = 0xffffffff;
    bytes4 public constant ERC165ID = 0x01ffc9a7;
    bytes32 public constant ERC820_ACCEPT_MAGIC = keccak256("ERC820_ACCEPT_MAGIC");
    ...
    /// @dev Sets an external `manager` that will be able to call `setInterfaceImplementer()`
    ...
    /// @dev Sets the contract that will handle a specific interface; only
